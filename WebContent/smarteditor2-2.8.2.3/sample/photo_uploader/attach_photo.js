    ...
    function html5Upload() {	
    	...
    	sUploadURL='/1001_JSP_Project/smarteditor2-2.8.2.3/sample/photo_uploader/file_uploader_html5.jsp'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			...
 			sUrl : '/file_uploader.jsp',	//파일업로드를 처리하는 URL
 			sCallback : '/smarteditor2-2.8.2.3/sample/photo_uploader/callback.html', //sURL에서 처리한 다음 파일정보를 return해준 뒤 리턴값을 callback.html에서 처리
